...
class Post {
  ...
  Future<bool> toggleLikedStatus() async {
    ...
    final Uri endpoint = isLiked
        ? Uri.parse(
            "$cohostBase/rc/relationships/project-615/to-post-$postToLike/unlike")
        : Uri.parse(
            "$cohostBase/rc/relationships/project-615/to-post-$postToLike/like");
  ...
  Future<void> deletePost() async {
    ...
    Response res = await delete(endpoint,
        headers: {'Cookie': 'connect.sid=${AppSecrets.cookie}'});
